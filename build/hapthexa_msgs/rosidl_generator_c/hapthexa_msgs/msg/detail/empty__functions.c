...
hapthexa_msgs__msg__Empty__create(void)
{
  ...
  hapthexa_msgs__msg__Empty * msg = (hapthexa_msgs__msg__Empty *)allocator.allocate(sizeof(hapthexa_msgs__msg__Empty), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hapthexa_msgs__msg__Empty));
  bool success = hapthexa_msgs__msg__Empty__init(msg);
  if (!success) {
...
hapthexa_msgs__msg__Empty__destroy(hapthexa_msgs__msg__Empty * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    hapthexa_msgs__msg__Empty__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
hapthexa_msgs__msg__Empty__Sequence__init(hapthexa_msgs__msg__Empty__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hapthexa_msgs__msg__Empty * data = NULL;

  if (size) {
    data = (hapthexa_msgs__msg__Empty *)allocator.zero_allocate(size, sizeof(hapthexa_msgs__msg__Empty), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hapthexa_msgs__msg__Empty__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hapthexa_msgs__msg__Empty__fini(&data[i - 1]);
      }
...
hapthexa_msgs__msg__Empty__Sequence__fini(hapthexa_msgs__msg__Empty__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hapthexa_msgs__msg__Empty__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hapthexa_msgs__msg__Empty__Sequence * array = (hapthexa_msgs__msg__Empty__Sequence *)allocator.allocate(sizeof(hapthexa_msgs__msg__Empty__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hapthexa_msgs__msg__Empty__Sequence__init(array, size);
  if (!success) {
...
hapthexa_msgs__msg__Empty__Sequence__destroy(hapthexa_msgs__msg__Empty__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hapthexa_msgs__msg__Empty__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hapthexa_msgs__msg__Empty__Sequence__are_equal(const hapthexa_msgs__msg__Empty__Sequence * lhs, const hapthexa_msgs__msg__Empty__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hapthexa_msgs__msg__Empty__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hapthexa_msgs__msg__Empty__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hapthexa_msgs__msg__Empty);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hapthexa_msgs__msg__Empty * data =
      (hapthexa_msgs__msg__Empty *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hapthexa_msgs__msg__Empty__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hapthexa_msgs__msg__Empty__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hapthexa_msgs__msg__Empty__copy(
