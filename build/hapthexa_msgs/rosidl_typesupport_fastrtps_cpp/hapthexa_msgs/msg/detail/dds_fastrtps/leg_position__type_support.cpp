...
#include "hapthexa_msgs/msg/detail/leg_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hapthexa_msgs::msg::LegPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hapthexa_msgs::msg::LegPosition & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hapthexa_msgs::msg::LegPosition;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const hapthexa_msgs::msg::LegPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hapthexa_msgs::msg::LegPosition *>(
    untyped_ros_message);
...
{
  return &hapthexa_msgs::msg::typesupport_fastrtps_cpp::_LegPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hapthexa_msgs, msg, LegPosition)() {
  return &hapthexa_msgs::msg::typesupport_fastrtps_cpp::_LegPosition__handle;
}
