...
#include "hapthexa_msgs/msg/detail/attitude__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hapthexa_msgs::msg::Attitude & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hapthexa_msgs::msg::Attitude & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hapthexa_msgs::msg::Attitude;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hapthexa_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hapthexa_msgs::msg::Attitude *>(
    untyped_ros_message);
...
{
  return &hapthexa_msgs::msg::typesupport_fastrtps_cpp::_Attitude__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hapthexa_msgs, msg, Attitude)() {
  return &hapthexa_msgs::msg::typesupport_fastrtps_cpp::_Attitude__handle;
}
